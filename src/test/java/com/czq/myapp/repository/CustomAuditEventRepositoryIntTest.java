package com.czq.myapp.repository;

import com.czq.myapp.MyJhipsterApplicationApp;
import com.czq.myapp.config.Constants;
import com.czq.myapp.config.audit.AuditEventConverter;
import com.czq.myapp.domain.PersistentAuditEvent;
...
import static com.czq.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
